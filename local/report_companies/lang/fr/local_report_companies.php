...
$string['childcompany'] = 'C\'est une compagnie d\'enfants. Le parent est \'{$a}\'';
$string['companies'] = 'Entreprises';
$string['completed'] = 'Achevé';
$string['course'] = 'Cours';
$string['coursemanagers'] = 'Directeurs d\'entreprise';
$string['courseusers'] = 'Utilisateurs de l\'entreprise';
$string['departmentmanagers'] = 'Directeurs de département';
$string['iomad_companies:view'] = 'Rapport des entreprises de l\'OIMAD';
...
$string['pluginname'] = 'Rapport d\'ensemble de l\'OIMAD';
$string['privacy:metadata'] = 'Le rapport d\'ensemble de la société locale IOMAD ne montre que les données stockées dans d\'autres endroits.';
...
$string['completionreportlink'] = 'Renseignements sur l\'achèvement';
