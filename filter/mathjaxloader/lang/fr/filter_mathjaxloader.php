...
$string['httpsurl_help'] = 'URL complète de la bibliothèque MathJax.';
$string['texfiltercompatibility'] = 'Compatibilité du filtre TeX';
...
$string['localinstall'] = 'Installation locale MathJax';
...
$string['mathjaxsettings_desc'] = 'La configuration par défaut de MathJax devrait être appropriée pour la plupart des utilisateurs, mais MathJax est hautement configurable et toutes les options de configuration standard de MathJax peuvent être ajoutées ici.';
$string['privacy:metadata'] = 'Le plugin MathJax ne stocke aucune donnée personnelle.';
