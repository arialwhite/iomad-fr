...
$string['pluginname'] = 'IOMAD Fusionner les comptes utilisateurs';
$string['privacy:metadata'] = 'L\'IOMAD Fusionner le plugin Compte utilisateur ne stocke aucune donnée personnelle.';
