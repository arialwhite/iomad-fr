...
$string['approveusers:addinstance'] = 'Ajouter Approuver l\'instance de l\'événement de formation';
$string['approveusers:myaddinstance'] = 'Ajouter Approuver le bloc de l\'événement de formation à la page';
$string['approveuserstitle'] = 'Gérer les autorisations d\'accès';
$string['deny'] = 'Refuser';
$string['enrolledcourse'] = "Cours";
$string['fullybooked'] = "L'événement est plein";
$string['headerconfig'] = "Une en-tête Config";
$string['lastname'] = "Nom";
$string['manager_approved'] = 'Administrateur approuvé';
$string['manager_denied'] = 'Gestionnaire refusé';
$string['managernotyetapproved'] = '(Le gestionnaire du ministère n\'a pas encore approuvé)';
...
$string['privacy:metadata:block_iomad_approve_access:companyid'] = 'Société';
$string['privacy:metadata:block_iomad_approve_access:courseid'] = 'Nom du cours';
