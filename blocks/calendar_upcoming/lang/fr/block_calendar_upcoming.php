...
$string['gotocalendar'] = 'Allez dans le calendrier...';
$string['pluginname'] = 'Événements à venir';
$string['privacy:metadata'] = 'Le bloc des événements à venir affiche uniquement les données de calendrier existantes.';
