...
$string['crontask'] = 'Microapprentissage de l\'OIMAD';
...
$string['iomad_microlearning:view'] = 'Voir le microapprentissage de l\'OIMAD';
...
$string['pluginname'] = 'Filets de microapprentissage de l\'OIMAD';
$string['privacy:metadata'] = 'L\'OIMAD Le bloc de microapprentissage ne présente que les données stockées dans d\'autres endroits.';
